    ...
    $output = '<header class="py-3 mb-4 border-bottom bg-white">
        <div class="d-flex flex-wrap justify-content-center container">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="alarm.html" class="nav-link bg-danger text-white">Alarm</a></li>
...
function getTodo($todo)
{
    $output = '<div class="card shadow-sm">
        <div class="card-body">
            ...
            <p class="card-date">'. textLimit($todo['date'], 100) .'</p>
            <p class="card-time">'. textLimit($todo['time'], 100) .'</p>
